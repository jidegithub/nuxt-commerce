<template>
  <header class="bg-gray-900">
    <section class="max-w-md sm:max-w-xl lg:max-w-6xl mx-auto sm:flex sm:justify-between sm:items-center sm:py-3">
      <div class="flex items-center justify-between items-baseline px-4 py-3 sm:p-0">
        <div>
          <img class="h-8" src='../assets/logo.svg' alt="Workcation">
        </div>
        <div class="sm:hidden">
